...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        ...
        user2 = get_user_model().objects.create_user(
            "other@example.com", "password#123"
        )
    ...
    def test_create_recipe_with_ingredients(self):
        """Test creating recipe which have ingredients"""
...
class RecipeImageUploadTest(TestCase):
    ...
    def test_upload_image_bad_request(self):
        ...
        url = image_upload_url(self.recipe.id)
        res = self.client.post(url, {'image': "no image"},
                               format="multipart")
    ...
    def test_filter_recipe_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title="Push beans and toast")
        ...
        recipe3 = sample_recipe(user=self.user, title="Setak and mushrooms")
